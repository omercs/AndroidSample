...
class HttpWebRequest extends AsyncTask<Void, Void, HttpWebResponse> {
    ...
    private SSLContext mSSSLContext = null;
    ...
    protected void onPreExecute() {
        ...
        if(_connection instanceof HttpsURLConnection && mSSSLContext != null) {
            ((HttpsURLConnection)_connection)
                 .setSSLSocketFactory(mSSSLContext.getSocketFactory());
        }
    }
    ...
    public SSLContext getSSSLContext() {
        return mSSSLContext;
    }

    public void setSSLContext(SSLContext mSSSLContext) {
        this.mSSSLContext = mSSSLContext;
    }
}
